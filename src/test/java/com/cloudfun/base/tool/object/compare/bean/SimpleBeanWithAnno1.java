 ...
 */
public class SimpleBeanWithAnno1 {
    ...
    public static SimpleBeanWithAnno1 createTargetBean() {

        SimpleBeanWithAnno1 simpleBean = new SimpleBeanWithAnno1();
        simpleBean.setId(2L);
    ...
    public static SimpleBeanWithAnno1 createOriginBean() {
        SimpleBeanWithAnno1 simpleBean = new SimpleBeanWithAnno1();
        simpleBean.setId(1L);
